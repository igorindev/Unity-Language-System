...
namespace LanguageController
{
    ...
    public class LanguageManager : MonoBehaviour
    {
        ...
        public string GetContentAtIndex(int lineNo)
        {
            ...
            return temp.Split(splitValue)[SelectedLanguageIndex];
        }
        public string GetContentAtIndex(string textIdentifier)
        {
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                {
                    return lines[i].Split(splitValue)[SelectedLanguageIndex];
                }
            }
        ...
        /// <summary>
        /// Set the texts in the scene
        /// </summary>
        /// <param name="textDefinersInScene">The text components in scene</param>
